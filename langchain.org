...
#+begin_src shell :session venv-setup :results output
  ${host_py} -m venv ${venv}
  ${venv_py} -m pip install langchain-ollama deepagents pydantic
#+end_src
...
Collecting deepagents
  Using cached deepagents-0.6.11-py3-none-any.whl.metadata (8.3 kB)
Collecting pydantic
...
Collecting langchain-anthropic<2.0.0,>=1.4.6 (from deepagents)
  Using cached langchain_anthropic-1.4.6-py3-none-any.whl.metadata (3.2 kB)
...
Collecting langchain<2.0.0,>=1.3.9 (from deepagents)
...
Collecting langgraph<1.3.0,>=1.2.5 (from langchain<2.0.0,>=1.3.9->deepagents)
  Using cached langgraph-1.2.6-py3-none-any.whl.metadata (4.9 kB)
Collecting anthropic<1.0.0,>=0.96.0 (from langchain-anthropic<2.0.0,>=1.4.6->deepagents)
  Using cached anthropic-0.111.0-py3-none-any.whl.metadata (3.2 kB)
Collecting distro<2,>=1.7.0 (from anthropic<1.0.0,>=0.96.0->langchain-anthropic<2.0.0,>=1.4.6->deepagents)
  Using cached distro-1.9.0-py3-none-any.whl.metadata (6.8 kB)
Collecting docstring-parser<1,>=0.15 (from anthropic<1.0.0,>=0.96.0->langchain-anthropic<2.0.0,>=1.4.6->deepagents)
  Using cached docstring_parser-0.18.0-py3-none-any.whl.metadata (3.5 kB)
Collecting jiter<1,>=0.4.0 (from anthropic<1.0.0,>=0.96.0->langchain-anthropic<2.0.0,>=1.4.6->deepagents)
  Using cached jiter-0.15.0-cp314-cp314-macosx_11_0_arm64.whl.metadata (5.2 kB)
Collecting sniffio (from anthropic<1.0.0,>=0.96.0->langchain-anthropic<2.0.0,>=1.4.6->deepagents)
...
Collecting google-genai<3.0.0,>=1.65.0 (from langchain-google-genai<5.0.0,>=4.2.5->deepagents)
  Using cached google_genai-2.9.0-py3-none-any.whl.metadata (53 kB)
...
Collecting langgraph-checkpoint<5.0.0,>=4.1.0 (from langgraph<1.3.0,>=1.2.5->langchain<2.0.0,>=1.3.9->deepagents)
  Using cached langgraph_checkpoint-4.1.1-py3-none-any.whl.metadata (5.2 kB)
Collecting langgraph-prebuilt<1.2.0,>=1.1.0 (from langgraph<1.3.0,>=1.2.5->langchain<2.0.0,>=1.3.9->deepagents)
  Using cached langgraph_prebuilt-1.1.0-py3-none-any.whl.metadata (5.2 kB)
Collecting langgraph-sdk<0.5.0,>=0.4.2 (from langgraph<1.3.0,>=1.2.5->langchain<2.0.0,>=1.3.9->deepagents)
  Using cached langgraph_sdk-0.4.2-py3-none-any.whl.metadata (3.6 kB)
Collecting ormsgpack>=1.12.0 (from langgraph-checkpoint<5.0.0,>=4.1.0->langgraph<1.3.0,>=1.2.5->langchain<2.0.0,>=1.3.9->deepagents)
...
Using cached langsmith-0.8.18-py3-none-any.whl (508 kB)
...
Using cached deepagents-0.6.11-py3-none-any.whl (230 kB)
Using cached langchain-1.3.10-py3-none-any.whl (133 kB)
Using cached langchain_anthropic-1.4.6-py3-none-any.whl (51 kB)
Using cached anthropic-0.111.0-py3-none-any.whl (929 kB)
Using cached anyio-4.14.0-py3-none-any.whl (123 kB)
Using cached distro-1.9.0-py3-none-any.whl (20 kB)
Using cached docstring_parser-0.18.0-py3-none-any.whl (22 kB)
Using cached jiter-0.15.0-cp314-cp314-macosx_11_0_arm64.whl (310 kB)
Using cached langchain_google_genai-4.2.5-py3-none-any.whl (69 kB)
Using cached filetype-1.2.0-py2.py3-none-any.whl (19 kB)
Using cached google_genai-2.9.0-py3-none-any.whl (950 kB)
...
Successfully installed annotated-types-0.7.0 anthropic-0.111.0 anyio-4.14.0 bracex-2.6 certifi-2026.6.17 cffi-2.0.0 charset_normalizer-3.4.7 cryptography-49.0.0 deepagents-0.6.11 distro-1.9.0 docstring-parser-0.18.0 filetype-1.2.0 google-auth-2.55.0 google-genai-2.9.0 h11-0.16.0 httpcore-1.0.9 httpx-0.28.1 idna-3.18 jiter-0.15.0 jsonpatch-1.33 jsonpointer-3.1.1 langchain-1.3.10 langchain-anthropic-1.4.6 langchain-core-1.4.8 langchain-google-genai-4.2.5 langchain-ollama-1.1.0 langchain-protocol-0.0.18 langgraph-1.2.6 langgraph-checkpoint-4.1.1 langgraph-prebuilt-1.1.0 langgraph-sdk-0.4.2 langsmith-0.8.18 ollama-0.6.2 orjson-3.11.9 ormsgpack-1.12.2 packaging-26.2 pyasn1-0.6.3 pyasn1-modules-0.4.2 pycparser-3.0 pydantic-2.13.4 pydantic-core-2.46.4 pyyaml-6.0.3 requests-2.34.2 requests-toolbelt-1.0.0 sniffio-1.3.1 tenacity-9.1.4 typing-extensions-4.15.0 typing-inspection-0.4.2 urllib3-2.7.0 uuid-utils-0.16.2 wcmatch-10.1 websockets-15.0.1 xxhash-3.7.0 zstandard-0.25.0

[notice] A new release of pip is available: 26.1.1 -> 26.1.2
[notice] To update, run: /private/tmp/langchain/bin/python -m pip install --upgrade pip
[?2004hecho 'ob_comint_async_shell_end_8504a6a3-a15f-4251-96ab-f31102f08fb8'[?2004l
#+end_example
