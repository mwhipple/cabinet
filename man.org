:PROPERTIES:
:header-args: :session man :results output :async
:ID:       40282DAC-6B66-47A9-9884-06CCC930D29D
:END:
#+title: man

man can be invoked within this space,
but similar to other utilities it should make sure to use a session
even if it is not seemingly required, otherwise the results will
include some control characters which can garble the contents or
require additional post-processing.

This is something that should ideally be absorbed by [[id:0F78767D-42FF-4027-B3A2-26CA1898F788][obi]] (which should
remove support for some of the problematic modes).
...
macOS 26.3                      January 9, 2021                     macOS 26.3
[?2004hecho 'ob_comint_async_shell_end_f2a33388-c560-449c-9202-883bb89eeb0d'[?2004l
#+end_example
...
macOS 26.3                      August 14, 2021                     macOS 26.3
[?2004hecho 'ob_comint_async_shell_end_00721480-fbf1-4b32-80c0-7b09a14919d4'
#+end_example
